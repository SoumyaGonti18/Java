class Test 
{
	...
	double ratings=4.5;
	String description="The Professor make a group of people to robbery a bank.He guides the people in the group from outside.The process of entering into the bank and leaving the bank is this series.";
